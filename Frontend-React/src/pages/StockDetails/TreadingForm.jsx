...
const TreadingForm = () => {
  ...
  const handleOnChange = (e) => {
    ...
    setAmount(amount);
    const volume = calculateBuyCost(amount, coin.coinDetails.market_data.current_price.rupee);
    setQuantity(volume);
  };

  function calculateBuyCost(amountRUPEE, cryptoPrice) {
    let volume = amountRUPEE / cryptoPrice;
    ...
    <div className="space-y-10 p-5">
      <div>
        ...
        {orderType == "SELL"?
          ...
          ):(quantity * coin.coinDetails?.market_data.current_price.rupee >
        ...
        <div>
          ...
          <div className="flex items-end gap-2">
            <p className="text-xl font-bold">
              {coin.coinDetails?.market_data.current_price.rupee}
            </p>
            <p
              className={`${
      ...
      <div className="">
        <DialogClose className="w-full">
          ...
          disabled={
            ...
            (orderType == "SELL" ?
              (asset.assetDetails?.quantity * coin.coinDetails?.market_data.current_price.rupee <
                amount):quantity * coin.coinDetails?.market_data.current_price.rupee >
                wallet.userWallet?.balance)
          }
        >
          {orderType}
