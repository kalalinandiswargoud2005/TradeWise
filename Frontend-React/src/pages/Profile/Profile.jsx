            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"KALALI NANDEESHWAR GOUD"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Date Of Birth : </p>
                  <p className="text-gray-500">{"15/02/2005"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"MIYAPUR,MADINAGUDA"} </p>
                </div>
                <div className="flex">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{500050} </p>
                </div>
                <div className="flex">
